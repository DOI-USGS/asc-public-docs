...
Chandrayaan 2 images from the TMC-2 and OHRC instruments are available in the PDS-4 standard.  They can be imported with [`isisimport`](https://isis.astrogeology.usgs.gov/Application/presentation/Tabbed/isisimport/isisimport.html).  Templates to import images from either instrument are included and should be autodetected in ISIS versions 10.0 and above.
