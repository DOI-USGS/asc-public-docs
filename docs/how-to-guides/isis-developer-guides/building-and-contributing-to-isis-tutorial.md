...
## 2. Example Issue: Converting Apps and Tests

A long-standing issue is the old apps/tests that 
need to be refactored for the gtest suite.
You can tell if an app has been refactored or not 
by what `.cpp`, `.h` and `.xml` files are under the app's directory:
...
!!! example "Example: See the [old version of `bandtrim`](https://github.com/DOI-USGS/ISIS3/tree/a28654ac754852f188be4c9710d001172ba459ac/isis/src/base/apps/bandtrim) vs. the [refactored `bandtrim`](https://github.com/DOI-USGS/ISIS3/tree/dev/isis/src/base/apps/bandtrim)."
...
After finding a suitable old-style app to refactor, follow the steps in 
[Refactoring ISIS3 Applications](../../how-to-guides/isis-developer-guides/writing-isis-tests-with-ctest-and-gtest.md/#refactoring-isis-applications) 
in your selected app.

To write a new test suite with gtest, follow the steps in 
[Creating a new test suite](../../how-to-guides/isis-developer-guides/writing-isis-tests-with-ctest-and-gtest.md/#creating-a-new-test-suite). 
